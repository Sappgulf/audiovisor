...
export const THEMES = [
  ...
  { id: 'amber', name: 'Hi-Fi Amber', colors: ['#ffb45c', '#ff8a3d', '#fff1d6'], css: 'linear-gradient(135deg, #ffb45c, #ff8a3d)' },
  { id: 'candy', name: 'Candy', colors: ['#ff5ea8', '#3df2c4', '#ffd93b'], css: 'linear-gradient(135deg, #ff5ea8, #3df2c4)' },
